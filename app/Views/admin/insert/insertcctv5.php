...
<form action="<?= base_url('/Produk/insertcctv5'); ?>" method="post" enctype="multipart/form-data"> 
 <?= csrf_field(); ?>
  <div class="row mb-3">
  ...
  <div class="row mb-3 form-group">
      <label for="foto" class="col-sm-2 col-form-label custom-file-label" >Gambar Produk</label>
      <div class="col-sm-2">
