...
<div class="card h-100">
           <div class="card-body">
  <div class="font-weight-bold display-6 mb-4">Update Data Running Text 2 Sisi</div>
  <form action="/Produkrunt/updateRunt2/<?= $produkrunt['id'] ?>" method="post" enctype="multipart/form-data">
   <?= csrf_field(); ?>
