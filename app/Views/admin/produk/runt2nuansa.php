...
<div class="container-lg my-5 container-md container ">
 ...
 <div class="row">
    ...
    <?php 
        ...
        <div class="card d-inline-block mt-2  " style="width: 22rem;">
          ...
          <div class="card-body">
            ...
            <?= $row['status'] ?>
            <a href="/Produkrunt/detailrunt/<?= $row['id'] ?>" class="btn btn-primary">Detail Paket</a>
            <br>
            <div class="mt-2">

             <a href="/Produkrunt/editrunt2/<?= $row['id'] ?>" class="btn btn-warning">Edit</a>
             <form action="/Produkrunt/deleterunt2/<?= $row['id']; ?>" method="post" class="d-inline hapusdatarunt2">
              <?= csrf_field(); ?>
  ...
  <div class="row mt-3">
    ...
    <div class="col-lg-11">
    <a class="btn btn-primary btn-sm" href="/Produkrunt/tambahrunt2" role="button"> Tambah Data</a>
...
<script>
  $('.hapusdatarunt2').submit(function(e){
          e.preventDefault();
          var id =  $(this).data('id');
