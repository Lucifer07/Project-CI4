        ...
        <?php 
              ...
              <div class="card-body">
                ...
                <div class="card-footer  pt-0 border-top-0 bg-transparent">
                  <div class="text-center">
                    <a class="btn btn-outline-primary mt-auto" href="/Produk/detailcctv5/<?= $row['id'] ?>">Detail Paket</a>
                  </div>
                            
                </div>
                <div class="text-center ">
                    <a class="btn btn-warning d-inline btn-md" href="/Produk/editcctv5/<?= $row['id'] ?>">Edit</a>
                     
                    <form action="/Produk/deletecctv5/<?= $row['id']; ?>" method="post" class="hapuscctv2 d-inline">
                      <?= csrf_field(); ?>
          ...
          <div class="row mt-3">
            ...
            <div class="col-lg-11">
              ...
              <a class="btn btn-primary btn-sm" href="/Produk/tambahcctv5" role="button"> Tambah Data</a>
            </div>
          </div>
</div>
