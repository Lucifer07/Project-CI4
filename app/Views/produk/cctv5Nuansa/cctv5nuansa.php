...
<div class="row">
      ...
      <?php foreach($cctv5Model as $row): ?>
        <?php 
              ...
              ?>
            <div class="card d-inline-block mt-2 ml-2  " style="width: 22rem;">
              ...
              <div class="card-body">
                ...
                <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-primary mt-auto" href="/Produk/detailcctv5/<?= $row['id'] ?>">Detail Paket</a></div>
                            </div>
              </div>  
            </div>
            <?php endforeach ?>
